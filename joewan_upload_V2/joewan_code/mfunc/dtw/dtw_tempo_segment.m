% function [auto_tempo_segment, MOTION_te, recognized_labels]=dtw_tempo_segment(Ktr, train_labels, K0, with_rest_position)
function [auto_tempo_segment MOTION_te ]=dtw_tempo_segment(Ktr, K0, with_rest_position)
